       ...
       <div id="phoneUI" class="form-group call_page">
          <div class="input-group" style="text-align: -webkit-center">
             <div class="input-group-btn">
                ...
                <div id="sip-dialpad" style="width: 292px">
                   ...
                   <div class="btn-call">
                      ...
                      <button class="btn btn-sm btn-primary volume dropdown-toggle" id="btnVol" data-bs-toggle="dropdown" aria-expanded="false" title="Volume">
                         <i class="fas fa-volume-up"></i>
                      </button>
                      <div class="dropdown-menu dropdown-menu-end">
                        <input type="range" min="0" max="100" value="100" step="1" id="sldVolume" class="form-range"/>
                      </div>
